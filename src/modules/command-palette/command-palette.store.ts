...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/kevinpinscoe/eng-tools',
      category: 'External',
      description: 'View the source code of eng-tools on GitHub.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve eng-tools.',
      href: 'https://github.com/kevinpinscoe/eng-tools/issues/new/choose',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about Engineering Tools.',
      to: '/about',
      category: 'Pages',
